function sonuc_getir() {if(gercek_g_semptomlardizisi.length==0){document.getElementById("sonuclistesi").value = "Semptom/Bulgu ekleyiniz..."; document.getElementById("girilensemptomlarlistesi").value = "Semptom/Bulgu ekleyiniz...";}else{var sonuclardizisi = new Array();
// Tüm semptomları yaz
